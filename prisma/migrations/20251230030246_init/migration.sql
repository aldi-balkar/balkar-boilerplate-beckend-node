...
-- CreateEnum
CREATE TYPE "AuditAction" AS ENUM ('LOGIN', 'REGISTER', 'CREATE', 'UPDATE', 'DELETE', 'LOGOUT');

-- CreateEnum
CREATE TYPE "StorageType" AS ENUM ('local', 'asset_service');
...
-- CreateIndex
CREATE INDEX "files_assetServiceId_idx" ON "files"("assetServiceId");
